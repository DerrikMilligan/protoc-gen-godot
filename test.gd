...
class TestProtobufEncoder:
  ...
  static func test_message_encoding():
    ...
    assert(TestMessage.new({ "sub_map": { "a": { "int32": 1 }, "b": SubMessage.new({ "int32": 2 }) } }).encode() == PackedByteArray([
  ...
  static func test_message_decoding():
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x08, 0x7B])).fields['int32'].get_value() == 123)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0xC8, 0x83, 0x06, 0xB2, 0x92, 0x04])).fields['big_int32'].get_value() == 67890)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x08, 0x85, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x01])).fields['int32'].get_value() == -123)
    assert(TestMessage.from_bytes(PackedByteArray([0x10, 0x7B])).encode() == TestMessage.new({ "int64": 123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x10, 0x7B])).fields['int64'].get_value() == 123)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x10, 0x85, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x01])).fields['int64'].get_value() == -123)
    assert(TestMessage.from_bytes(PackedByteArray([0x1D, 0x79, 0xE9, 0xF6, 0x42])).encode() == TestMessage.new({ "float": 123.456 }).encode())
    var float_value = TestMessage.from_bytes(PackedByteArray([0x1D, 0x79, 0xE9, 0xF6, 0x42])).fields['float'].get_value()
    ...
    float_value = TestMessage.from_bytes(PackedByteArray([0x1D, 0x79, 0xE9, 0xF6, 0xC2])).fields['float'].get_value()
    assert(-123.457 <= float_value and float_value < -123.456) # Floats decode imprecisely beyond their initial precision
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x21, 0x77, 0xBE, 0x9F, 0x1A, 0x2F, 0xDD, 0x5E, 0x40])).fields['double'].get_value() == 123.456)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x21, 0x77, 0xBE, 0x9F, 0x1A, 0x2F, 0xDD, 0x5E, 0xC0])).fields['double'].get_value() == -123.456)
    assert(TestMessage.from_bytes(PackedByteArray([0x28, 0x7B])).encode() == TestMessage.new({ "uint32": 123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x28, 0x7B])).fields['uint32'].get_value() == 123)
    assert(TestMessage.from_bytes(PackedByteArray([0x30, 0x7B])).encode() == TestMessage.new({ "uint64": 123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x30, 0x7B])).fields['uint64'].get_value() == 123)
    assert(TestMessage.from_bytes(PackedByteArray([0x38, 0xF6, 0x01])).encode() == TestMessage.new({ "sint32": 123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x38, 0xF6, 0x01])).fields['sint32'].get_value() == 123)
    assert(TestMessage.from_bytes(PackedByteArray([0x38, 0xF5, 0x01])).encode() == TestMessage.new({ "sint32": -123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x38, 0xF5, 0x01])).fields['sint32'].get_value() == -123)
    assert(TestMessage.from_bytes(PackedByteArray([0x40, 0xF6, 0x01])).encode() == TestMessage.new({ "sint64": 123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x40, 0xF6, 0x01])).fields['sint64'].get_value() == 123)
    assert(TestMessage.from_bytes(PackedByteArray([0x40, 0xF5, 0x01])).encode() == TestMessage.new({ "sint64": -123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x40, 0xF5, 0x01])).fields['sint64'].get_value() == -123)
    assert(TestMessage.from_bytes(PackedByteArray([0x4D, 0x7B, 0x00, 0x00, 0x00])).encode() == TestMessage.new({ "fixed32": 123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x4D, 0x7B, 0x00, 0x00, 0x00])).fields['fixed32'].get_value() == 123)
    assert(TestMessage.from_bytes(PackedByteArray([0x5D, 0x7B, 0x00, 0x00, 0x00])).encode() == TestMessage.new({ "sfixed32": 123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x5D, 0x7B, 0x00, 0x00, 0x00])).fields['sfixed32'].get_value() == 123)
    assert(TestMessage.from_bytes(PackedByteArray([0x5D, 0x85, 0xFF, 0xFF, 0xFF])).encode() == TestMessage.new({ "sfixed32": -123 }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x5D, 0x85, 0xFF, 0xFF, 0xFF])).fields['sfixed32'].get_value() == -123)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x51, 0x7B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])).fields['fixed64'].get_value() == 123)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x61, 0x7B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])).fields['sfixed64'].get_value() == 123)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x61, 0x85, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF])).fields['sfixed64'].get_value() == -123)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x68, 0x01])).fields['bool'].get_value() == true)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x72, 0x03, 0x01, 0x02, 0x03])).fields['bytes'].get_value() == PackedByteArray([0x01, 0x02, 0x03]))
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x7A, 0x0C, 0x54, 0x65, 0x73, 0x74, 0x20, 0x53, 0x74, 0x72, 0x69, 0x6E, 0x67, 0x21])).fields['string'].get_value() == "Test String!")
    ...
    assert(TestMessage.from_bytes(PackedByteArray([0x82, 0x01, 0x02, 0x08, 0x7B])).fields['sub_message'].get_value().fields['int32'].get_value() == 123)
    ...
    assert(TestMessage.from_bytes(PackedByteArray([
      ...
      0x8A, 0x01, 0x05, 0x0A, 0x01, 0x62, 0x10, 0x02,
      0x8A, 0x01, 0x05, 0x0A, 0x01, 0x63, 0x10, 0x03
    ])).fields['map'].get_value() == { "a": 1, "b": 2, "c": 3 })
    assert(TestMessage.from_bytes(PackedByteArray([
      0x92, 0x01, 0x07, 0x0A, 0x01, 0x61, 0x12, 0x02, 0x08, 0x01,
      0x92, 0x01, 0x07, 0x0A, 0x01, 0x62, 0x12, 0x02, 0x08, 0x02
    ])).encode() == TestMessage.new({ "sub_map": { "a": { "int32": 1 }, "b": SubMessage.new({ "int32": 2 }) } }).encode())
    var sub_map = TestMessage.from_bytes(PackedByteArray([
      0x92, 0x01, 0x07, 0x0A, 0x01, 0x61, 0x12, 0x02, 0x08, 0x01,
      0x92, 0x01, 0x07, 0x0A, 0x01, 0x62, 0x12, 0x02, 0x08, 0x02
    ])).fields['sub_map'].get_value()
    assert(sub_map['a'].fields['int32'].get_value() == 1)
    assert(sub_map['b'].fields['int32'].get_value() == 2)
    assert(TestMessage.from_bytes(PackedByteArray([0x9A, 0x01, 0x03, 0x01, 0x02, 0x03])).encode() == TestMessage.new({ "r_int32": [ 1, 2, 3 ] }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0x9A, 0x01, 0x03, 0x01, 0x02, 0x03])).fields['r_int32'].get_value() == [ 1, 2, 3 ])
    ...
    var mixed_message = TestMessage.from_bytes(PackedByteArray([0x08, 0x7B, 0x10, 0xC8, 0x03, 0x51, 0x15, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]))
    assert(mixed_message.fields['int32'].get_value() == 123)
    assert(mixed_message.fields['int64'].get_value() == 456)
    assert(mixed_message.fields['fixed64'].get_value() == 789)
    assert(TestMessage.from_bytes(PackedByteArray([0xA0, 0x01, 0x01])).encode() == TestMessage.new({ "enum": TestEnum.FIRST }).encode())
    assert(TestMessage.from_bytes(PackedByteArray([0xA0, 0x01, 0x01])).fields['enum'].get_value() == TestEnum.FIRST)
